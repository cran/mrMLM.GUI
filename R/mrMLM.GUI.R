      ...
      if (input$layout == "mrMLM") {
        ...
        tabPanel("",
                 ...
                 column(10,
                        ...
                        h4("2. Wen YJ, Zhang H, Ni YL, Huang B, Zhang J, Feng JY, Wang SB, Jim M Dunwell, Zhang YM*, Wu R*. 2018.
                           Methodological implementation of mixed linear models in multi-locus genome-wide association studies. 
                           Briefings in Bioinformatics 19(4): 700-712 doi:10.1093/bib/bbw145 (FASTmrEMMA)"),
                        ...
                        h4("4. Wang SB, Feng JY, Ren WL, Huang B, Zhou L, Wen YJ, Zhang J, Jim M Dunwell, Xu S*, Zhang YM*.
                           2016. Improving power and accuracy of genome-wide association studies via a multi-locus mixed
                           linear model methodology. Scientific Reports 6:19444. doi:10.1038/srep19444 (mrMLM)"),
                        
                        h4("5. Tamba CL, Zhang YM. 2018. A fast mrMLM algorithm for multi-locus genome-wide association studies.
                           bioRxiv preprint first posted online Jun. 7, 2018, doi: https://doi.org/10.1101/341784. (FASTmrMLM)"),
                        
                        h4("6. Zhang J, Feng JY, Ni YL, Wen YJ, Niu Y, Tamba CL, Yue C, Song QJ, Zhang YM*. pLARmEB: 
                           integration of least angle regression with empirical Bayes for multi-locus genome-wide association
                           studies. Heredity 118(6): 517-524. doi:10.1038/hdy.2017.8 (pLARmEB)"),
                        
                        h4("7. Ren WL, Wen YJ, Jim M Dunwell, Zhang YM*. 2018. pKWmEB: integration of Kruskal-Wallis test with
                           empirical Bayes under polygenic background control for multi-locus genome-wide association study. 
                           Heredity 120(3): 208-218. https://doi.org/10.1038/s41437-017-0007-4 (pKWmEB)"),             
                        ...
                        h4("mrMLM.GUI version 3.2, Realeased August 2018"),
        ...
        fluidPage(  
          ...
          navlistPanel(
            ...
            tabPanel("Manhattan Plot",id="manp",
                     ...
                     fluidRow(
                       column(12,
                              radioButtons("Precisionman", "Select resolution of plot", c("General resolution", "High resolution", "Set by yourself"),inline = TRUE)
                       ),
                       column(3,
            ...
            tabPanel("QQ Plot",id="qqp",
                     ...
                     fluidRow(
                       ...
                       column(12,
                              radioButtons("Precisionqq", "Select resolution of plot", c("General resolution", "High resolution", "Set by yourself"),inline = TRUE) 
                       ),
            ...
            tabPanel("Plot of LOD Score against Genome position",id="lodp",
                     ...
                     fluidRow(
                       ...
                       column(12,
                              radioButtons("Precisionlod", "Select resolution of plot", c("General resolution", "High resolution", "Set by yourself"),inline = TRUE) 
                       ),
